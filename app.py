...
# Apply CSS for dark mode or light mode
def local_css(css):
...
if page == "Home":
    ...
    # Colorful journaling area with styled markdown
    st.markdown("""
    <style>
    .journal-container {
    ...
    st.markdown('<div class="journal-container"><label for="journal_entry"><b>Write your thoughts or feelings (optional):</b></label></div>', unsafe_allow_html=True)
    journal_entry = st.text_area("", key="journal_entry", help="Journaling helps with emotional release.", placeholder="Start typing your journal entry here...", label_visibility="collapsed")
